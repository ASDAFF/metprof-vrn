									...
									?>
										...
										<?elseif ($domainCode == 'own'):?>
											...
											<div class="landing-alert landing-alert-info">
												...
												<p class="landing-alert-paragraph">
													<i><span id="landing-form-domain-name-text" class="landing-form-domain-name-text"><?= $domainNameOriginal ? $domainNameOriginal : 'landing.mydomain';?></span>. IN CNAME lb<?= $b24Postfix;?>.</i><br/>
