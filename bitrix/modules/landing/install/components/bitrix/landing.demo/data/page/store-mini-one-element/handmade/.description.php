					...
					'nodes' =>
						array(
							...
							'.landing-block-node-card-subtitle' =>
								array(
									0 => '<span style="font-weight: bold;font-style: italic;">Акция от<br />Handmade-магазинчика &quot;Мечта&quot;!</span>',
								),
							'.landing-block-node-card-title' =>
								array(
									0 => '<span style="font-weight: 400;">Браслеты из натуральных камней всего по 250 рублей!</span>',
								),
					...
					'nodes' =>
						array(
							...
							'.landing-block-node-text' =>
								array(
									0 => '<p>Мы изготавливаем различные украшения: кольца, серьги, кулоны, браслеты. <br /><span style="font-size: 1.14286rem;">У нас есть как готовые украшение, так и под заказ!</span></p>',
								),
						),
					'style' =>
						array(
