					...
					<div class="col-md-5 g-px-5 g-mb-20 g-mb-0--md">
						<div class="media">
							...
							<div class="landing-block-node-place-title-container media-body text-uppercase g-color-white-opacity-0_5">
								<div class="landing-block-node-place-title g-mb-5 g-font-size-14 "><span style="font-weight: bold;">где</span></div>
					...
					<div class="g-mx-minus-2 g-my-minus-2">
						<div class="row mx-0">
							...
							<span class="landing-block-card-contact-icon-container g-color-primary">
								...
								<div class="landing-block-card-contact-text g-font-size-11 g-color-gray-dark-v1"><span style="font-weight: bold;">Улица и дом с офисом</span></div>
							</div>
