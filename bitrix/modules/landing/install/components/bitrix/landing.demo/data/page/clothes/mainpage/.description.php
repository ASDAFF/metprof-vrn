  ...
  array (
    ...
    array (
      ...
      array (
        ...
        array (
          0 => '<span style="font-weight: 700;">Ценопад! Успейте купить на этой неделе!</span>',
          1 => '<span style="font-weight: bold;">Новая коллекция обуви</span>',
        ),
        '.landing-block-node-card-title' => 
        array (
          0 => '<span style="font-weight: normal;">Наступила осень. Желтеют и опадают листья, навевая уныние и тоску о закончившемся лете. Раскрасьте хмурые будни, спешите на осеннюю акцию Ценопад! Лучшие цены осени, только качественные товары!</span>',
          1 => '<span style="font-weight: normal;">Девочки и мальчики, мужчины и прекрасные дамы, спешите! Новое поступление обуви. Отличное качество, известные бренды. В наличии весь размерный ряд.</span>',
        ),
    ...
    array (
      ...
      array (
        ...
        array (
          0 => '<p>Выполнили <br />свыше <br />150 000 заказов</p>',
          1 => '<p>Более 10 лет <br />успешной <br />работы</p>',
          2 => '<p>Более <br />50 000 <br />покупателей</p>',
          3 => '<p>Контракты <br />с домами <br />мод</p>',
          4 => '<p>Оригинальные и<br />всегда новейшие <br />модели</p>',
          5 => '<p>Круглосуточная <br />поддержка<br />покупателей</p>',
        ),
        '.landing-block-node-card-title' => 
        array (
          0 => ' ',
    ...
    array (
      ...
      array (
        '.landing-block-node-subtitle' => 
        array (
          0 => 'Доставка во все регионы России!',
        ),
        '.landing-block-node-title' => 
        array (
          0 => '<span style="font-weight: normal;">Вы делаете покупки, а мы с любовью доставляем ваш заказ в любой уголок нашей необъятной родины. А за заказ от 2 500 рублей доставка будет абсолютно бесплатной.</span>',
        ),
    ...
    array (
      ...
      array (
        '.landing-block-node-subtitle' => 
        array (
          0 => '<span style="font-weight: normal;">Сезонная распродажа</span>',
        ),
        '.landing-block-node-title' => 
        array (
          0 => 'Скидки до 50% на всю одежду в конце сезона',
        ),
        '.landing-block-node-mainimg' => 
        array (
          0 => 
    ...
    array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            'text' => 'Получено прочное водостойкое соединение',
          ...
          1 => 
          array (
            'text' => 'Международная выставка одежды Salon De Fashion',
          ...
          2 => 
          array (
            'text' => 'Форум производителей одежды в России',
