  ...
  array (
    ...
    array (
      ...
      array (
        ...
        array (
          0 => 'Форум производителей одежды в России',
        ),
    ...
    array (
      ...
      array (
        ...
        array (
          0 => '<span style="font-weight: bold;">Сектор готовой одежды</span>',
          1 => '<span style="font-weight: bold;">Сектор материалов</span>',
        ),
        ...
        array (
          0 => '<p>Вы увидите одежду для дома, <span style="">для детей и молодежи, для спорта и отдыха, а также для офиса.</span></p>',
          1 => '<p>Вас ждут новинки рынка одежной фурнитуры, материалов, тканей, элементов и аксессуаров для производства одежды.</p>',
        ),
      ),
      'style' => 
      array (
    ...
    array (
      ...
      array (
        ...
        '.landing-block-node-text' => 
        array (
          0 => '<p>Помимо расширенной экспозиции пяти тематических выставок &quot;Экспофорум&quot; подготовил разнообразную деловую программу форума производителей Одежды. В рамках выставки состоятся семинары и мастер-классы. И поистине масштабным в этом году обещает стать республиканский конкурс форума &quot;Народное признание&quot;. В этом году он выходит за рамки выставки и становится республиканским смотром образцов одежды. <br /><br /><span style="font-size: 1.14286rem;">Форум производителей Одежды предоставляет специалистам возможность познакомиться с тенденциями моды, провести переговоры, получить практические предложения рынка, увидеть перспективы развития и новые конкурентные преимущества. <br /></span></p>',
        ),
        '.landing-block-node-img' => 
        array (
          0 => 
