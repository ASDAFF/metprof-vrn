  ...
  array (
    ...
    array (
      ...
      array (
        ...
        '.landing-block-node-text' => 
        array (
          0 => '<p>Мы рады приветствовать вас на сайте нашей компании!<br /><span style="">Наша компания была основана в 1993 году, а наш интернет-магазин стал одним из первых магазинов, осуществляющих on-line продажу одежды в регионе. Компания специализируется на оптовой и розничной продаже одежды как для дома, так и для офиса.<br /></span><span style="">На данный момент мы представляем собой крупную компанию, владеющую интернет–магазином и имеющую в своей сети единый call-центр, который регулирует всю деятельность магазина, отдел продаж, службу доставки, широкий штат квалифицированных сборщиков, собственный склад c постоянным наличием необходимого запаса товаров.<br /></span><span style="">За это время у нас сложились партнерские отношения с ведущими производителями, позволяющие предлагать высококачественную продукцию по конкурентоспособным ценам.<br /></span><span style="">Мы можем гордиться тем, что у нас один из самых широких ассортиментов одежды в городе и области.</span></p>',
        ),
    ...
    array (
      ...
      array (
        ...
        array (
          0 => '<span style="font-weight: bold;">Быстрая<br /> доставка</span>',
          1 => '<span style="font-weight: bold;">Низкие<br />цены</span>',
          2 => '<span style="font-weight: bold;">Широкий<br />ассортимент</span>',
          3 => '<span style="font-weight: bold;">Бонусы и<br />Подарки</span>',
          4 => '<span style="font-weight: bold;">Отличное<br />обслуживание</span>',
          5 => '<span style="font-weight: bold;">Сезонные<br />скидки</span>',
        ),
      ...
      array (
        ...
        array (
          0 => 'landing-block-node-card js-animation fadeInUp col-md-6 text-center g-mb-40 g-mb-0--lg animated landing-card col-lg-2',
        ),
        '.landing-block-node-card-number' => 
        array (
        ...
        array (
          ...
          1 => 'landing-block-node-card-icon-container u-icon-v1 u-icon-size--lg g-color-white-opacity-0_7 g-mb-15',
          2 => 'landing-block-node-card-icon-container u-icon-v1 u-icon-size--lg g-color-white-opacity-0_7 g-mb-15',
          3 => 'landing-block-node-card-icon-container u-icon-v1 u-icon-size--lg g-color-white-opacity-0_7 g-mb-15',
          4 => 'landing-block-node-card-icon-container u-icon-v1 u-icon-size--lg g-color-white-opacity-0_7 g-mb-15',
          5 => 'landing-block-node-card-icon-container u-icon-v1 u-icon-size--lg g-color-white-opacity-0_7 g-mb-15',
        ),
        '#wrapper' => 
        array (
    ...
    array (
      ...
      array (
        ...
        '.landing-block-node-text' => 
        array (
          0 => '<p>Мы предлагаем огромный выбор одежды различных брендов, с которыми сотрудничаем на протяжении многих лет.</p>',
        ),
      ),
      'style' => 
      array (
