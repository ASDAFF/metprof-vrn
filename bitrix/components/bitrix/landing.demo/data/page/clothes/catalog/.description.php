  ...
  array (
    ...
    array (
      ...
      array (
        ...
        array (
          0 => '<span style="font-weight: normal;">Скидки на коллекции прошлого сезона</span>',
        ),
        '.landing-block-node-title1' => 
        array (
          0 => '<span style="font-weight: bold;">До 60%</span>',
        ),
        ...
        array (
          0 => '<span style="font-weight: normal;">Скидка 20%</span>',
        ),
        '.landing-block-node-title2' => 
        array (
          0 => '<span style="font-weight: bold;">На футболки</span>',
        ),
        '.landing-block-node-text2' => 
        array (
          0 => '<span style="font-weight: normal;">При покупке от 2000 рублей!</span>',
        ),
        ...
        array (
          0 => '<p>Уже в нашем магазине!</p>',
          1 => '<p>Купите ремень, второй подарим!</p>',
        ),
