			...
			<div class="container">
				...
				<div class="collapse navbar-collapse align-items-center flex-sm-row" id="navBar">
					<ul class="landing-block-node-menu-list js-scroll-nav navbar-nav text-uppercase g-font-weight-700 g-font-size-12 g-pt-20 g-pt-0--lg ml-auto">
						...
						<li class="landing-block-node-menu-list-item nav-item g-mx-10--lg g-mb-7 g-mb-0--lg">
							<a href="#block@block[04.1.one_col_fix_with_title@5]" class="landing-block-node-menu-list-item-link nav-link p-0 g-color-black" target="_self">OUR TEAM</a>
						</li>
						<li class="landing-block-node-menu-list-item nav-item g-mx-10--lg g-mb-7 g-mb-0--lg">
						...
						<li class="landing-block-node-menu-list-item nav-item g-ml-10--lg">
							<a href="#block@block[33.23.form_2_themecolor_no_text]" class="landing-block-node-menu-list-item-link nav-link p-0 g-color-black" target="_self">CONTACTS</a>
						</li>
					</ul>
				</div>
				<!-- End Navigation -->
